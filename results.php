...
<div class="right_content">                                  <!--right content start--> 
    ...
    <script>
        jssor_slider1_starter = function (containerId) {
            ...
            function ScaleSlider() {
                ...
                if (bodyWidth)
                    jssor_slider1.$ScaleWidth(Math.min(bodyWidth, 1400));//width or hieght of slider
                else
    ...
    <div id="slider1_container" style="position: relative; margin: 0 auto;
        top: 0px; left:-153px; width: 1300px; height: 360px; overflow: hidden;">
        <!-- Loading Screen -->
...
$user_keyword=$_GET['user_query'];
 $get_pro="select *  from products where product_keywords like '%$user_keyword%' or product_title like '%$user_keyword%' ";
	...
	?>
                              ...
                              <div id="form"><!--form start -->
                                     ...
                                     <input type="Text" class="tftextinput" name="user_query" value="<?php echo $user_keyword;?>" size=55  placeholder="Search a product, Categories or a brand name "   />
