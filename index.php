...
<meta name="description" content="Shopking is a website which is owned by SS COMPUTECH, All types of Laptops, Computers, Computers Accessories, Computer Parts Etc.."/>

<meta name="keywords" content="shopking, electronics, shop, sscomputech, ss computech, onlinewebshop, shopping, assembled pc, pc, brand new computers, brand new laptops"/>
...
<div class="right_content">                                  <!--right content start--> 
        ...
        <div data-u="slides" style="cursor: move; position: absolute; left: 200px; top: 0px; width: 930px;
            ...
            <div>
                ...
                <div  style="position: absolute; width: 445px; height: 300px; top: 00px; left: 00px;">
                    <img src="img/1920/laptop.png" style="position: absolute; width: 400px; height: 290px; top: 30px; left: 30px;" alt="" />
                     <div style="position: absolute; width: 480px; height: 10px; top: 70px; left: 320px; padding: 5px;
                    text-align: right; line-height: 40px;font-size: 30px;
                        color: #FFFFFF;">All New Laptop and Desktop Pc</br>
						<font style='text-align:left'>On Finance</font><br><font style='font-weight:bold'> Bajaj Finance Available</font><br>
						<br><br>
						<font style='font-weight:bold;font-size:30px;font-family:tahoma'> S.S COMPUTECH</font>
            ...
            <div>
                ...
                <img src="img/1920/av.png" style="position: absolute;  top: 40px; left: 20px;" alt="" />
                 <div style="position: absolute; width: 480px; height: 10px; top: 90px; left: 410px; padding: 5px;
                    text-align: right; font-weight:bold; 40px;font-size: 30px;
                        color: #FFFFFF;">Protect Your PC From<br> Unwanted Viruses.</br>
            ...
            <div>
               ...
               <div style="position: absolute; width: 480px; height: 10px; top: 20px; left: 90px; padding: 5px;
                    text-align: right; font-weight:bold; 40px;font-size: 30px;
                        color: #FFFFFF;">Pheripheral Items</br>
    ...
    <!-- Jssor Slider End -->
									  ...
									  <div id="product_show">                                      <!--product_show start-->
									   <?php getPro("select * from products Random() ");?>
                                       <?php getcatPro("select * from products  ");?>
                              ...
                              <div id="form"><!--form start -->
                                     ...
                                     <input type="Text" id="results"class="tftextinput" onkeyup="getProduts(this.value)" name="user_query"  size=55  placeholder="Search a product, Categories or a brand name "   />
